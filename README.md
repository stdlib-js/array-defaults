...
```javascript
import defaults from 'https://cdn.jsdelivr.net/gh/stdlib-js/array-defaults@v0.4.0-esm/index.mjs';
```
...
[test-image]: https://github.com/stdlib-js/array-defaults/actions/workflows/test.yml/badge.svg?branch=v0.4.0
[test-url]: https://github.com/stdlib-js/array-defaults/actions/workflows/test.yml?query=branch:v0.4.0
